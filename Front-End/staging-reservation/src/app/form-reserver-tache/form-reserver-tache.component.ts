...
@Component({
  selector: 'app-form-reserver-tache',
  templateUrl: './form-reserver-tache.component.html',
  styleUrls: ['./form-reserver-tache.component.css']
})
export class FormReserverTacheComponent {
  reserver:any;
  msg:any;
  id:any;
  BookForm!: FormGroup;
  ...
  constructor(private rubyservice: RubyService, private route: ActivatedRoute,
    ...
    private router: Router
      ...
      this.BookForm = this.formBuilder.group({
        ...
        reserved_for:['', Validators.required]
      });
    }
